...
//
//import jiang.wsocial.emoji.imageloader.ImageBase;
//
...
//    }
//
//    public static ArrayList<Smiley> ParseXhsData(String[] arry, ImageBase.Scheme scheme) {
//        try {
//            ArrayList<Smiley> emojis = new ArrayList<>();
...
//                        Smiley bean = new Smiley(fileName, content);
//                        emojis.add(bean);
//                    }
//                }
//            }
...
//    }
//
//    public static ArrayList<Smiley> parseKaomojiData(Context context) {
//        ArrayList<Smiley> textEmotionArray = new ArrayList<>();
//        try {
//            InputStreamReader inputStreamReader = new InputStreamReader(context.getAssets().open("kaomoji"));
//            BufferedReader bufferedReader = new BufferedReader(inputStreamReader);
//            String line;
//            while ((line = bufferedReader.readLine()) != null) {
////                Smiley bean = new Smiley(line.trim());
...
//    }
//
//    public static EmoticonPageSetEntity<Smiley> parseDataFromFile(Context context, String filePath, String assetsFileName, String xmlName) {
