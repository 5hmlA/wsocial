...
public class W9ShowPicsLayout extends FrameLayout implements View.OnClickListener {
    ...
    private OnAddPicListener mCallback;
    ...
    public W9ShowPicsLayout(Context context, @Nullable AttributeSet attrs){
        super(context, attrs);
    ...
    public void onClick(View v){
        if(mVisiblePictureList.contains(v)){

        }else if(mCallback != null) {
            mCallback.on2PictureClick((ImageView)v, mVisiblePictureList);
        }
    }
    ...
    public interface OnAddPicListener {
         ...
         */
        void on2PictureClick(ImageView i, List<ImageView> imageGroupList);
    }

    public void setOnAddPicListener(OnAddPicListener callback){
        mCallback = callback;
    }
    ...
    public W9ShowPicsLayout setSingleMaxHSize(int singleMaxHSize){
        mSingleMaxHSize = singleMaxHSize;
        return this;
    }

    public W9ShowPicsLayout setSingleMaxSize(int singleMaxSize){
        mSingleMaxSize = singleMaxSize;
        return this;
    }

    public W9ShowPicsLayout setPlaceHolder(int placeHolder){
        mPlaceHolder = placeHolder;
        return this;
    }

    public W9ShowPicsLayout setErrorHolder(int errorHolder){
        mErrorHolder = errorHolder;
        return this;
    }

    public W9ShowPicsLayout setSpace(int space){
        mSpace = space;
        return this;
    }
}
