package social.jiang.emotionkeyboard.emotioninput;
...
import social.jiang.emotionkeyboard.utils.KeyboardUtil;
...
public class SmileyContainer extends FrameLayout {
    ...
    public void init(EditText editText, View smileyBtn, final View sendBtn) {
        if (editText != null) {
            ...
            EmotionInputHandler handler = new EmotionInputHandler(editText,
                    new EmotionInputHandler.TextChangeListener() {
